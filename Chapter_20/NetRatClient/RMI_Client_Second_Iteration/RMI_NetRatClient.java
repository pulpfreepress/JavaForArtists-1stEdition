...
public class RMI_NetRatClient extends JFrame implements ActionListener {
  ...
  private RobotRatFactoryInterface _robot_rat_factory = null;
  ...
  try{
     _robot_rat_factory = (RobotRatFactoryInterface)Naming.lookup("rmi://" + host + "/Robot_Rat_Factory");
     _robot_rat = _robot_rat_factory.getRobotRat();
...
}// end NetRatClient class definition

...
public class CommandProperties extends Properties {
   ...
   private static final String CLASS_A_CLASSNAME			= "ClassA";
   private static final String CLASS_B_CLASSNAME			= "ClassB";
   private static final String CLASS_C_CLASSNAME			= "ClassC";
   ...
   private CommandProperties( String properties_file ){
      try{
         ...
         load(fis);
          ...
          try{
            File file = new File(PROPERTIES_FILE_VALUE);
            ...
            setProperty(CLASS_A, CLASS_A_CLASSNAME);
            setProperty(CLASS_B, CLASS_B_CLASSNAME);
            setProperty(CLASS_C, CLASS_C_CLASSNAME);
...
****************************************************************************************************/
   ...
   public void reloadPropertiesFile(String properties_file){
      try{

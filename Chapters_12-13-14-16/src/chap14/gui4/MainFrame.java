...
public class MainFrame
  extends JFrame
  implements CheckboxListCell.ToggleListener {
  ...
  public MainFrame() {
    ...
    cellHandler.addToggleListener(this);
    garmentList.addMouseListener(cellHandler);
    garmentList.setCellRenderer(cellHandler);
		//contentPane.add("West", garmentList);
		contentPane.add("Center", garmentList);
